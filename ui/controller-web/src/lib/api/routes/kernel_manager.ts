import type { Config, KernelConnectionAndState, ResultObject } from "../types";
...
export const kernelManagerApi = {
    ...
    updateConfig: (config: Config) => fetchJson<ConfigUpdateResults>('/api/kernel_manager/update_config', {
        method: 'POST',
